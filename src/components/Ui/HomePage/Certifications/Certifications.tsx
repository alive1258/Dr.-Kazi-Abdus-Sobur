        ...
        {activeTab === "endorsements" && (
          <div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {topEndorsements.map((item) => (
                <div
                  key={item.id}
                  className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1"
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                    ...
                    <div className="bg-indigo-100 text-indigo-700 text-xs font-bold px-2.5 py-1 rounded-full">
                      {item.count}
                    </div>
                  </div>
                  <div className="mt-3 flex items-center gap-2 text-xs text-gray-400">
                    ...
                    <span>
                      {item.count}{" "}
                      {item.count === 1 ? "endorsement" : "endorsements"} in the
                      last 6 months
                    </span>
                  </div>
                </div>
